...
def add_deployment_requirements_redis_server_module(deployment_requirements, module_name, module_dict):
    deployment_requirements["redis-server"]["modules"][module_name] = module_dict


def add_deployment_requirements_utilities(deployment_requirements, utility_name, utility_dict):
...
def generate_setup_json(json_version, project, use_case_specific_arguments, test_name, description, run_stages,
                        deployment_requirements, key_metrics, inputs,
                        setup_commands, teardown_commands, used_keys,
                        total_commands, total_setup_commands, total_benchmark_commands, total_setup_writes,
                        total_writes,
...
def add_key_metric(key_metrics, step, metric_family, metric_json_path, metric_name, metric_unit, metric_type,
                   comparison_mode_str, per_step_priority):
    km = {
        "step": step,
