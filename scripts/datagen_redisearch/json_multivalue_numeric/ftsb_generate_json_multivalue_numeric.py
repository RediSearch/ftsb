...
def use_case_csv_row_to_cmd(doc_id):
    doc = {
        "numericIntArray": rand_numeric_arr(1, 10),
        "numericFloatArray": rand_numeric_float_arr(1, 10),
    }
    docid_str = "doc:multi:{hash}:{n}".format(hash=uuid.uuid4().hex, n=doc_id)
...
def ft_search_numeric_int(index_name):
    ...
    return [
        ...
        "FT.SEARCH",
        index_name,
        "'@numericIntArray:[{} {}]'".format(val_from, val_to),
        "NOCONTENT",
    ]
...
def ft_search_numeric_float(index_name):
    ...
    return [
        ...
        "FT.SEARCH",
        index_name,
        "@numericFloatArray:[{} {}]".format(val_from, val_to),
        "NOCONTENT",
    ]
...
SEARCH_NUMERIC_FLOAT = "FT.SEARCH-MULTIVALUE-FLOAT"
SEARCH_NUMERIC_INT = "FT.SEARCH-MULTIVALUE-INT"
""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--test-name",
        type=str,
        default="multivalue-numeric-json",
