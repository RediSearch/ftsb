...
| 5 | agg-5-*-1month-approximate-top10-editor-usernames | One month period, Approximate All time Top 10 Revision editor usernames. | `-GROUPBY` <br/>   `--REDUCE` <br/>`-FILTER` <br/>`-SORTBY` <br/>`-LIMIT` <br/> |  [Follow link](scripts/test_agg.sh#L220) | :heavy_multiplication_x:
