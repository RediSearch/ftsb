...
| agg-aproximate-avg-editor-contributions-by-year |   Aproximate average number of contributions by year each editor makes | - APPLY <br/>- GROUPBY <br/>   - - REDUCE <br/>- APPLY - SORTBY <br/> |  [Follow link](scripts/test_agg.sh#L262) | :heavy_multiplication_x:
